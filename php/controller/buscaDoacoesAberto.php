    ...
    <tbody>
        ...
        if($_SESSION['perfil'] == 1){
            if($nome == ''){
                ...
                INNER JOIN tabmensageiro ON tabdoacao.idmensageirodoacao = tabmensageiro.idmensageiro
                INNER JOIN tabstatus ON tabstatus.idtabstatus = tabdoacao.doacaostatus
                WHERE tabdoacao.doacaostatus = 1 AND tabcontribuinte.nomecontribuinte LIKE '%$nome%' OR tabdoacao.doacaostatus = 1 AND tabdoacao.iddoacao LIKE '%$nome%'
            ...
            if($nome == ''){
                ...
                INNER JOIN tabmensageiro ON tabdoacao.idmensageirodoacao = tabmensageiro.idmensageiro
                INNER JOIN tabstatus ON tabstatus.idtabstatus = tabdoacao.doacaostatus
                WHERE tabdoacao.doacaostatus = 1 AND taboperador.idoperador = $idoper AND  tabcontribuinte.nomecontribuinte LIKE '%$nome%' OR tabdoacao.iddoacao LIKE '%$nome%' 
                ORDER BY tabdoacao.datavencimentodoacao";
            }
        }
