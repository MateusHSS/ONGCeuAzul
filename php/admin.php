        ...
        <nav class="nav-extended">
            ...
            <div class="container menu">
                ...
                <ul id="doacoes-menu" class="dropdown-content">
                    ...
                    <li><a href='consulta/doacoesQuitado.php'>Quitado/Indefertotaisido</a></li>
                </ul>
                ...
                <ul id="usuario-menu" class="dropdown-content">
                    <li><a href='#'><i class="material-icons">add</i>Novo</a></li>
                    <li><a href='#'><i class="material-icons">list</i>Listagem</a></li>
                </ul>
