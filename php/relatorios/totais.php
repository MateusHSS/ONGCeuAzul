...
<head>
    ...
    <title>ONG Céu azul - Doações em aberto</title>
            ...
            <div class="col l2">
                <div class="row">
                    <form action="#" method='post' class='center'>
                            ...
                            <div class="input-field col l12">
                                <select id='filtroStat'>
                                    ...
                                    <optgroup label="Operador">
                                        ...
                                        ?>
                                        <option class='filtro' id='filtroOper'
                                            value='oper<?php echo $res['idoperador'] ?>'>
                                    ...
                                    <optgroup label="Status">
                                        <?php
                                            include '../config/conexao.php';
                                            $sql = "SELECT * FROM tabstatus ORDER BY idtabstatus";
                                            $result=$connect->query($sql);
                                            while($res = $result->fetch_array()){
                                        ?>
                                        <option class='filtro' id='filtroOper'
                                            value='stts<?php echo $res['idtabstatus'] ?>'>
                        ...
                        <button class='btn blue lighten-2 center' id='filtro-data'>Filtrar
                                                ...
                                                <div class='row'>
                                                    <div class="container center">
                                                        <form action="#" class='col l12 center'>
                                                            ...
                                                            <div class='btn blue lighten-2 botao' type='submit'
                                                                name='action'
