...
<head>
    ...
    <title>ONG - Cadastro mensageiro</title>
...
<body>
    ...
    <main>
        <div class="row">
            ...
            <div class="col l8">
                <form class="col m12 center" id='formUser' action="../controller/insereMens.php" method='POST'>
                    <div class="row">
                        ...
                        <div class="input-field col l3">
                            <input id="rg" type="text" class="validate" name='rg' required>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col l3">
                            <input id="placa" type="text" class="validate" name='placa' required>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col l3">
                            <input id="num" type="text" class="validate" name='num' required>
